// src/components/layout/StoreCover.tsx
"use client";
...
const Info = styled.div`padding-top: 38px;`;

const StoreName = styled.h1`
  font-family: ${({ theme }) => theme.fonts.display};
  font-size: 20px; font-weight: 800; margin-bottom: 3px;
`;
...
const WaBtn = styled.a`
  ...
  gap: 7px; padding: 9px 16px; border-radius: ${({ theme }) => theme.radii.full};
...
const ShareBtn = styled.button`
  padding: 9px 18px; border-radius: ${({ theme }) => theme.radii.full};
...
export default function StoreCover({ store }: Props) {
  ...
  return (
    <>
      ...
      <ProfileWrap>
        <AvatarRing>
          <AvatarInner>{store.logoEmoji}</AvatarInner>
        </AvatarRing>
        <Info>
